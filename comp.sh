...
gcc -ansi -Wextra -Werror -pedantic-errors -lm -c src/jacobi.c -o bin/jacobi.o
...
gcc bin/myIO.o bin/datastructures.o bin/lnorm.o bin/eigengap.o bin/jacobi.o bin/spkmeans.o bin/calculate_w.o \
-o spkmeans -lm
